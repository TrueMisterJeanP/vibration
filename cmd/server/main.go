...
func main() {
	...
	mux.Handle("GET /api/conversations/{id}/keys", authHandler.Middleware(http.HandlerFunc(conversationHandler.Keys)))
	mux.Handle("POST /api/conversations/{id}/members", authHandler.Middleware(http.HandlerFunc(conversationHandler.AddMember)))
	mux.Handle("POST /api/conversations/{id}/rotate-keys", authHandler.Middleware(http.HandlerFunc(conversationHandler.RotateGroupKeys)))
	...
	mux.Handle("GET /api/files/limits", authHandler.Middleware(http.HandlerFunc(fileHandler.UploadLimits)))
