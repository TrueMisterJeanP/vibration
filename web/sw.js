const CACHE = "chat-pwa-go-v302";
const SHELL = [
  "/", "/index.html", "/login.html", "/link-device.html", "/share.html", "/css/style.css?v=group-member-spacing-v302",
  "/js/app.js?v=group-member-spacing-v302", "/js/api.js?v=ios17-pdf-v199", "/js/crypto.js", "/js/websocket.js?v=ios-resume-v297", "/js/keyed-task-guard.js?v=ios17-pdf-v199", "/js/theme.js?v=macos-titlebar-v251",
  "/js/notifications.js?v=group-member-spacing-v302", "/js/device-vault.js?v=trusted-device-v300", "/js/identity-trust.js?v=passphrase-strength-v276", "/js/i18n.js?v=ios-resume-v297", "/js/ui.js?v=ios-resume-v297", "/js/share.js?v=ios17-pdf-v199", "/js/login.js?v=group-member-spacing-v302", "/js/link-device.js?v=ios-resume-v297", "/js/qr-scanner.js?v=qr-scanner-v296", "/manifest.json?v=desktop-titlebar-v252",
