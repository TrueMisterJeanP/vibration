const CACHE = "chat-pwa-go-v249";
const SHELL = [
  "/", "/index.html", "/login.html", "/share.html", "/css/style.css?v=startup-preload-v249",
  "/js/app.js?v=startup-preload-v249", "/js/api.js?v=ios17-pdf-v199", "/js/crypto.js", "/js/websocket.js?v=ios17-pdf-v199", "/js/keyed-task-guard.js?v=ios17-pdf-v199", "/js/theme.js?v=startup-preload-v249",
  "/js/notifications.js?v=carnet-v221", "/js/device-vault.js", "/js/i18n.js", "/js/ui.js?v=ios17-pdf-v211", "/js/share.js?v=ios17-pdf-v199", "/js/login.js", "/manifest.json?v=startup-preload-v249",
...
const OPTIONAL_SHELL = ["/admin.html", "/js/admin.js?v=startup-preload-v249"];
