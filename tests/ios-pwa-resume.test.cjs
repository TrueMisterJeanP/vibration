...
assert.match(notifications, /register\("\/sw\.js\?v=ios-input-zoom-v303"\)/);
assert.match(worker, /chat-pwa-go-v303/);
assert.match(worker, /\/js\/app\.js\?v=ios-input-zoom-v303/);
