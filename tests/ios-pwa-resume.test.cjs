...
assert.match(notifications, /register\("\/sw\.js\?v=ios-landscape-splash-v304"\)/);
assert.match(worker, /chat-pwa-go-v304/);
assert.match(worker, /\/js\/app\.js\?v=ios-landscape-splash-v304/);
