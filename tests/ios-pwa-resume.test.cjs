...
assert.match(notifications, /register\("\/sw\.js\?v=community-1-0-25-v380"\)/);
assert.match(worker, /chat-pwa-go-v380/);
assert.match(worker, /\/js\/app\.js\?v=community-1-0-25-v380/);
assert.match(worker, /\/js\/notifications\.js\?v=community-1-0-25-v380/);
assert.match(worker, /\/js\/websocket\.js\?v=community-1-0-25-v380/);
