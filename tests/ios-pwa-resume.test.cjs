...
assert.match(notifications, /register\("\/sw\.js\?v=group-member-spacing-v302"\)/);
assert.match(worker, /chat-pwa-go-v302/);
assert.match(worker, /\/js\/app\.js\?v=group-member-spacing-v302/);
