...
func frenchErrorMessage(status int, message string) string {
	if translated, ok := map[string]string{
		...
		"invalid calendar feed":                           "Le flux calendrier est invalide.",
		"calendar feed creation failed":                   "La création du flux calendrier a échoué.",
		"calendar feed lookup failed":                     "La consultation du flux calendrier a échoué.",
		"calendar feed update failed":                     "La mise à jour du flux calendrier a échoué.",
		"calendar feed revocation failed":                 "La révocation du flux calendrier a échoué.",
		...
		"file quota lookup failed":                        "La consultation du quota de fichiers a échoué.",
		"file quota update failed":                        "La mise à jour du quota de fichiers a échoué.",
		"file exceeds configured size limit":              "Le fichier dépasse la taille maximale configurée.",
		"user file quota exceeded":                        "Le quota total de fichiers de cet utilisateur est atteint.",
		...
		"federated group recipient cannot be replaced":    "Le participant distant de ce groupe ne peut pas être remplacé directement.",
		...
		"invalid directory role":                          "Le rôle recherché est invalide.",
		...
		"invalid group key epoch":                         "La génération de clé du groupe n’est plus à jour.",
		"invalid group rotation":                          "Le renouvellement de la clé du groupe est invalide.",
		...
		"invalid message report reason":                   "Sélectionnez une infraction valide.",
		...
		"invitation code already exists":                  "Ce code d’invitation existe déjà.",
		"invitation creation failed":                      "La création de l’invitation a échoué.",
		"invitation lookup failed":                        "La consultation des invitations a échoué.",
		"invitation revocation failed":                    "La révocation de l’invitation a échoué.",
		"invitation unavailable":                          "Cette invitation a expiré, a déjà été utilisée ou a été révoquée.",
		...
		"group key rotation required":                     "La clé du groupe doit être renouvelée avant cette opération.",
		"group rotation failed":                           "Le renouvellement de la clé du groupe a échoué.",
		...
		"message report failed":                           "L’enregistrement du signalement a échoué.",
		"message report removal failed":                   "Le retrait du signalement a échoué.",
		"message report not found":                        "Ce signalement n’existe plus.",
		"message report lookup failed":                    "La consultation des signalements a échoué.",
		"message update failed":                           "La modification du message a échoué.",
		"cannot report own message":                       "Vous ne pouvez pas signaler votre propre message.",
		...
		"only the group owner can rotate keys":            "Seul le propriétaire du groupe peut renouveler sa clé.",
		"stale group key epoch":                           "La clé du groupe a changé. Rechargez la discussion puis réessayez.",
		"conversation membership changed":                 "Votre participation à cette discussion a changé.",
		...
		"session approval required":                       "Cette nouvelle session doit être approuvée depuis un appareil déjà connecté.",
		"session approval expired":                        "La demande d’approbation de cet appareil a expiré.",
		"session approval request not found":              "Cette demande d’approbation n’existe plus ou a expiré.",
		"session approval failed":                         "L’approbation de la session a échoué.",
		...
		"invalid trusted device credential":               "La clé de cet appareil est invalide.",
		"trusted device approval required":                "Cet appareil doit être approuvé depuis un appareil déjà connecté.",
		"trusted device enrollment failed":                "L’enregistrement de cet appareil de confiance a échoué.",
		"trusted device lookup failed":                    "La consultation des appareils de confiance a échoué.",
		"trusted device proof failed":                     "La preuve cryptographique de cet appareil a échoué.",
		"trusted device revocation failed":                "La révocation de cet appareil de confiance a échoué.",
		"trusted device not found":                        "Cet appareil de confiance n’existe plus.",
